...
INSERT INTO tb_conteudo (titulo) VALUES ('Primeiro conteúdo');
INSERT INTO tb_conteudo (titulo) VALUES ('Segundo conteúdo');
...
INSERT INTO tb_usuario_publicacao (id_usuario, id_publicacao, papel) VALUES (1, 1, 'Autor Principal');
INSERT INTO tb_usuario_publicacao (id_usuario, id_publicacao, papel) VALUES (2, 1, 'Coautor');
...
UPDATE tb_usuario_publicacao SET papel = 'Revisor' WHERE id_usuario = 2 AND id_publicacao = 1;
...
FROM tb_usuario u
JOIN tb_usuario_publicacao up ON u.id_usuario = up.id_usuario
